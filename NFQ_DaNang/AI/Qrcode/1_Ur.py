...
with open('hrdata/qrcode.csv') as file_read:                   # Tạo 1 list đã chứa những người đã checkin trong file csv
...
class Thread(QThread):
    ...
    def soud3(self, names):
        os.system("mpg123 amthanh/thanhcong.mp3")
    ...
    def save_status_id(self, codes):
        with open('hrdata/qrcode.csv', mode="w", newline='') as file_save:     # newline : bo cach dong
    ...
    def delete_data_csv(self):                                          # xóa file csv khi qua ngày mới
        with open('hrdata/qrcode.csv', mode="w") as detele_file_csv:
            detele_file_csv.truncate()
        detele_file_csv.close()

    def save_csv_backup(self,codes_backup):
        with open('hrdata/qrcode_backup.csv', mode="+a", newline='') as file_save_backup:     # newline : bo cach dong
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.result_qrcode.setGeometry(QtCore.QRect(10, 25, 960, 250))
        ...
        # self.no_internet.setGeometry(QtCore.QRect(403, 860, 274, 205))
        ...
        self.icon_ok.setGeometry(QtCore.QRect(458, 45, 64, 64))
        ...
        self.icon_not_ok.setGeometry(QtCore.QRect(458, 45, 64, 64))
